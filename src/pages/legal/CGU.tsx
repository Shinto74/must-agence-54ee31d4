...
export default function CGU() {
  ...
  return (
    <LegalLayout title={t("cgu_title", "Conditions Générales d'Utilisation")} intro={intro}>
      <h2>{t("cgu_h1", "1. Accès au site")}</h2>
      <p>
        {t(
          "cgu_p1",
      ...
      <h2>{t("cgu_h2", "2. Règles d'utilisation")}</h2>
      <p>{rules}</p>

      <h2>{t("cgu_h3", "3. Propriété intellectuelle")}</h2>
      <p>
        {t(
          "cgu_p3",
      ...
      <h2>{t("cgu_h4", "4. Données personnelles")}</h2>
      <p>
        {t("cgu_p4_a", "Le traitement des données personnelles est régi par notre")}{" "}
        <a href="/politique-confidentialite">{t("cgu_p4_b", "Politique de confidentialité")}</a>.
      </p>

      <h2>{t("cgu_h5", "5. Modifications")}</h2>
      <p>
        {t(
          "cgu_p5",
