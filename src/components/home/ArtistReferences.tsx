        ...
        {[...allArtists, ...allArtists].map((artist, i) => {
          ...
          return (
            <div
              ...
              className="group w-[165px] shrink-0 sm:w-[200px] md:w-[240px]"
            >
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-border transition-all duration-[550ms] group-hover:border-primary/30 group-hover:shadow-[0_0_20px_hsl(var(--neon)/0.12)]">
                <img
                  src={artist.image}
                  alt={artist.name}
                  className="h-full w-full object-cover grayscale transition-all duration-[550ms] group-hover:scale-[1.06] group-hover:grayscale-0"
                  loading="lazy"
                />
